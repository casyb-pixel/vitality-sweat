...
export async function generateMarketingPromos(
  ...
  const prompt = [
    ...
    "Write THREE platform-specific promo captions that drive clicks back to the live blog post AND invite a free Vitality Engine signup.",
    "",
    "PLATFORM RULES:",
    ...
    "",
    "GROWTH / LOCAL ANGLE (required soft CTA):",
    "- Mention the free Vitality Engine (workouts + meal plans) without sounding salesy.",
    "- Light Southwest Louisiana / Acadiana / SWLA framing when it fits the article.",
    "- Do NOT invent gym partnerships or sponsor claims.",
    "",
    "CRITICAL:",
